...
export class App extends Component {
  ...
  onclickhandler = (e) => {
    if (this.state.play) {
     ...
     console.log(!this.state.List[e.target.id],"aaaaaaaaaaaaaaaaaaaaaaaaaaa");
         console.log(!this.state.List[e.target.id - 1],"ddddddddddddddddddddddddd");
      if (!this.state.List[e.target.id - 1]) {
        var newlist = this.state.List;
        if (this.state.Player === 1) {
          //    console.log(newlist[e.target.id - 1]);
